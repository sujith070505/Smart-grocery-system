...
try {
    ...
    while (rs.next()) {
        ...
        double t = (rs.getBigDecimal("total_amount") != null ? rs.getBigDecimal("total_amount").doubleValue() : 0.0);
        totals.add(t);
        totalRevenue += t;
    ...
    while (rs.next()) {
        ...
        if (itemsMap.containsKey(oid)) {
            double price = (rs.getBigDecimal("price") != null ? rs.getBigDecimal("price").doubleValue() : 0.0);
